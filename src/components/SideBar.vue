  ...
  <aside class="sidebar">
    ...
    <div class="sidebar-footer">
      <template v-if="userStore.userInfo">
        ...
        <div class="menu-pill settings-pill" :class="{ active: isActive('/settings/account') }"
        ...
        <div class="user-pill"
             :class="{ active: route.path.startsWith('/space') }"
             @click="router.push(currentUser.user_id ? `/space?id=${currentUser.user_id}` : '/login')">
          <img alt="头像"
...
.user-pill.active .nickname {
  color: #FFFFFF;
}

.user-pill.active .user-tag {
