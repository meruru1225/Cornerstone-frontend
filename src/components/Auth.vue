...
const isPasswordFocus = ref(false) // 控制吉祥物是否闭眼
            ...
            <div v-else class="step-fade">
              <div class="input-group">
                ...
                <div class="gender-selector">
                  <div class="gender-option" :class="{ active: formData.gender === 1 }" @click="formData.gender = 1">♂
                    男生
                  </div>
                  <div class="gender-option" :class="{ active: formData.gender === 2 }" @click="formData.gender = 2">♀
                    女生
                  </div>
                  <div class="gender-option" :class="{ active: formData.gender === 0 }" @click="formData.gender = 0">?
                    保密
                  </div>
                </div>
